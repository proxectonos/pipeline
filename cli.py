...
def build_parser(handlers: Dict[str, Callable[[argparse.Namespace], None]]) -> argparse.ArgumentParser:
    ...
    p.add_argument("-md", "--model", type=str, default="sentence-transformers/LaBSE")
    p.add_argument("-d", "--device", type=str, default="cuda")
    p.add_argument("-bs", "--batch_size", type=int, default=256)
    p.add_argument("-st", "--score_threshold", type=float, default=0.65)
    ...
    p.add_argument("-mps", "--min_punctuation_similarity", type=float, default=0.15)
